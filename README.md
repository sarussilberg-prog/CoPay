...
- [docs/SSOT/README.md](docs/SSOT/README.md) — start here (routing index)
- [docs/SSOT/SRS.md](docs/SSOT/SRS.md) — requirements (`REQ-*`)
- [docs/SSOT/CODE QUALITY.md](docs/SSOT/CODE%20QUALITY.md) — architecture & patterns
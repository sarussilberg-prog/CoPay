#!/usr/bin/env bash
# Open Kupa dev client on a connected physical iPhone with the LAN Metro URL.
set -euo pipefail
...
echo "Opening Kupa on device with Metro at: ${METRO_URL}"
...
echo ""
echo "Could not auto-open. On iPhone in Kupa dev client:"

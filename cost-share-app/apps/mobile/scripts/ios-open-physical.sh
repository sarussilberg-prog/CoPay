#!/usr/bin/env bash
# Open CoPay dev client on a connected physical iPhone with the LAN Metro URL.
set -euo pipefail
...
echo "Opening CoPay on device with Metro at: ${METRO_URL}"
...
echo ""
echo "Could not auto-open. On iPhone in CoPay dev client:"
